...
<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'billing' ) ); ?>" class="add" style="margin-left: 0.5em;"><?php echo esc_html_x( 'Add', 'billing address', 'saved-addresses-for-woocommerce' ); ?></a></div><?
	} else {
		?>
		<header class="woocommerce-Address-title title">
...
<a href="<?php echo esc_url( get_saw_endpoint_url( 'edit-address', 'saw_shipping', 'add' ) ); ?>" class="add"><?php echo esc_html_x( 'Add new', 'shipping address', 'saved-addresses-for-woocommerce' ); ?></a></div>
			<?php
