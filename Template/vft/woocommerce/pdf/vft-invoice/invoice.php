...
<div class="container">
  <div class="header">
    <div class="logo">
      <picture>
        <source srcset="<?php echo get_bloginfo( 'template_directory' ); ?>/woocommerce/pdf/vft-invoice/src/img/logo.webp" type="image/webp"><img src="<?php echo get_bloginfo( 'template_directory' ); ?>/woocommerce/pdf/vft-invoice/src/img/logo.png" alt="" srcset="" />
      </picture>
    </div>
  </div>
  <div class="body">
  ...
  <div class="hz-kak-nazvat">
    <div class="hz-kak-nazvat__left">
      DDP Leitenweg <br />
...
<script src="js/app.min.js?_v=20220116021552"></script>