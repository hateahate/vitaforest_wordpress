    ...
    private function prepareFilterInputs( $filter )
    {
        ...
        if( $short_entity === 'taxonomy' ){
            if( is_taxonomy_hierarchical( $filter['e_name'] ) ){
                $short_entity = 'taxonomy taxonomy-hierarchical';
            }
        }
...
//            241 => esc_html__( 'Error: invalid Order field.', 'filter-everything' ),
            ...
            399 => esc_html__( 'Error: such prefix is not allowed. Please, use another prefix.', 'filter-everything' ),
            3991 => esc_html__( 'Error: such var name is not allowed. Please, use another name.', 'filter-everything' ),
