...
//        $postType   = isset( $queriedObject['post_types'] ) ? reset( $queriedObject['post_types'] ) : '';
    ...
    private function title()
    {
        if( ! $this->get('seoTitleDisplayed') ){
            ...
            echo sprintf( '<div itemscope itemtype="https://schema.org/FAQPage"><div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><title itemprop="name">%s</title>', esc_html($seoTitle) )."\r\n";
        }
    }
    ...
    private function description()
    {
        ...
        if( $description ){
            echo sprintf( '<div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><meta itemprop="text" name="description" content="%s" /></div></div></div>', esc_attr($description) )."\r\n";
        }
