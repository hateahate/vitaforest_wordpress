...
$free_limit_note = sprintf(__('<p>Note. You are using the free version and you can edit only users with "%s" role.</p>', $users_instance->textname), implode(', ', array_values(VGSE_Users_Helpers_Obj()->get_available_user_roles())));
