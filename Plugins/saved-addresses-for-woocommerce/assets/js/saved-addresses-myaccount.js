						...
						success: function( response ) {
							if ( response.default ) {
								if ( jQuery( this ).not( '#billing_address_' + response.default_id ) ) {
									...
									jQuery( ".account-billing-actions" ).find( 'address' ).removeClass( 'bs-default' ).addClass( 'bsn-default' );
								...
								jQuery( '#billing_address_' + response.default_id ).find('address').removeClass('bsn-default').addClass('bs-default');
						...
						success: function( response ) {
							if ( response.default ) {
								if ( jQuery( this ).not( '#shipping_address_' + response.default_id ) ) {
									...
									jQuery( ".account-shipping-actions" ).find( 'address' ).removeClass( 'ss-default' ).addClass( 'ssn-default' );
								...
								jQuery( '#shipping_address_' + response.default_id ).find('address').removeClass('ssn-default').addClass('ss-default');
