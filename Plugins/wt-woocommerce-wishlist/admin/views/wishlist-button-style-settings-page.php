        ...
        <table class="wt-form-table">
            <tbody>
                ...
                <tr valign="top" class="hide_text_element">
                    ...
                    <td  class="checkbox_options"> 
                        ...
                        <div class="wt_sub_option_div" style="padding-top:8px;">
                            ...
                            <div><input name="wt_wishlist_button_style_settings[wt_after_adding_product_text]" type="text" class="wt_after_adding_product_text" id="wt_wishlist_button_style_settings[wt_after_adding_product_text]" placeholder="<?php _e('Product added to wishlist','wt-woocommerce-wishlist'); ?>" value="<?php echo isset($wt_wishlist_button_style_settings_options['wt_after_adding_product_text']) ? $wt_wishlist_button_style_settings_options['wt_after_adding_product_text'] : '';  ?>" class="regular-text"></div>
                        </div>
                ...
                <tr valign="top" class="hide_button_element">
                    ...
                    <td  class="checkbox_options"> 
                        ...
                        <div class="wt_sub_option_div" style="padding-top:8px;">
                            ...
                            <div><input name="wt_wishlist_button_style_settings[wt_after_adding_product_button]" type="text" class="wt_after_adding_product_button" id="wt_wishlist_button_style_settings[wt_after_adding_product_button]" placeholder="<?php _e('Product added to wishlist','wt-woocommerce-wishlist'); ?>" value="<?php echo isset($wt_wishlist_button_style_settings_options['wt_after_adding_product_button']) ? $wt_wishlist_button_style_settings_options['wt_after_adding_product_button'] : '';  ?>" class="regular-text"></div>
                        </div>
                        <span class="wt_form_help"><?php _e('Choose ‘Add to wishlist’ style (text, icon, or button).','wt-woocommerce-wishlist'); ?></span>  
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <span class="wt_form_help"><?php _e("",'wt-woocommerce-wishlist'); ?></span>  
                    </th>
                    <td> 
