...
add_settings_field(
	...
	'afrfq_general_setting_section',                          // The page on which this option will be displayed.
	'afrfq-general-sec',         // The name of the section to which this field belongs.
	array( esc_html__( 'Select Menu where you want to show Mini quote Basket. If there is no menu then you have to create menu in WordPress menus otherwise mini quote basket will not show.', 'addify_rfq' ) )
);
